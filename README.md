...
```javascript
mskrange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-mskrange@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-mskrange/tags). For example,

```javascript
mskrange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-mskrange@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var mskrange = require( 'path/to/vendor/umd/stats-base-mskrange/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-mskrange@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/stats-base-mskrange/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/stats-base-mskrange/actions/workflows/test.yml?query=branch:v0.2.1
...
[deno-readme]: https://github.com/stdlib-js/stats-base-mskrange/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-mskrange/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-mskrange/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-mskrange/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-mskrange/blob/esm/README.md
